...
struct __mingw32_expanded_timespec *
mingw_timespec(struct timespec *__tv)
{
...
__attribute__((__cdecl__)) __attribute__((__nothrow__)) int nanosleep(const struct timespec *, struct timespec *);
